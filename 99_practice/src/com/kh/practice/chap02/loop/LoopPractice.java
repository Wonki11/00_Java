...
public class LoopPractice {
	...
	public void practice3() {
		...
		while (num >= 1) {
			...
			num--; // 키보드로 입력받은 숫자에서 계속 -1을 하면서 1이 될때까지 출력
		}
		//System.out.println();
	}
	...
	public void practice7() {
		...
		/*
		 사용자로 부터 두 개의 값을 입력 받아 그 사이의 숫자 출력하기
	...
	public void practice12() {
		...
		while(true) {
			System.out.println("프로그램 종료를 원할 경우 exit 입력");
			System.out.print("연산입력 (+ , - * , / , %)");
			
			operator = sc.next();
			
			//만약에 exit를 입력해서 프로그램 종료를 원할 경우
			//문자열 String으로 비교 할 경우 equals ==
			...
			if (operator.equals("+")) {
				...
				//break = 중괄호 탈출  continue = 다음 반복 실행
		}
	}
