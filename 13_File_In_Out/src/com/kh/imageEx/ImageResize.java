...
public class ImageResize {
	public static void main(String[] args) {
		...
		String 원본 = "src/com/kh/imageEx/marley.jpg";
		String 사이즈조정 = "src/com/kh/imageEx/marley_cute.jpg";
		...
		try {
			...
			//새로운 크기의 이미지 생성						가로길이	세로길이	이미지 어떤 타입으로 그릴지
			...
			Image 이미지그리기 = 원본이미지데이터.getScaledInstance(가로크기,세로크기,Image.SCALE_SMOOTH);
														//x 		y	효과추가여부
			크기조정이미지.createGraphics().drawImage(이미지그리기,가로크기,세로크기,null);
