...
public class Variable {
	...
	public static void main(String[] args) {
		...
		//문자를 나타내는 char은 ''작은 따옴표를 사용해서 표현한다
		//""큰 따옴표는 String 문자열을 나타내는 표현
		  ...
		  String introduction = "저는요. 서울에 사는 조원기 입니다.";
		  ...
		  System.out.println("입니다");
		  // char는 문자 하나 '작은따옴표사용' String은 여러글자 "큰따옴표사용"
		  ...
		  // 지정값을 생략한다
		  num = 20;
		  System.out.println("20으로 변경한 num의 값 : "+num);
